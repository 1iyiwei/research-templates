...
\definecolor{LiyiColor}{rgb}{0.7,0,0} % color for Sith
\definecolor{JunColor}{rgb}{0,0,0.8} % color for the Jedi Guardians (e.g. Obiwan)
\definecolor{MengqiColor}{rgb}{0.56,0.34,0.62} % 

\newcommand{\liyi}[1]{{\color{LiyiColor} Li-Yi: #1 $\qed$}}
\newcommand{\jun}[1]{{\color{JunColor} Jun: #1 $\qed$}}
\newcommand{\mengqi}[1]{{\color{MengqiColor} Mengqi: #1 $\qed$}}
